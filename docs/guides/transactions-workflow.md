...
{"ok":false,"error":{"code":"CONFIRMATION_REQUIRED","message":"this mutation operation requires --confirm to execute","category":"safety","retryable":false},"meta":{"command":"transactions.update","profile":"default","duration_ms":0,"schema_version":"2026-05-08","request_id":"9fee843f-dcf2-4484-89ac-df7a2c8c01e1"}}
$ echo $?
10
```
...
{"ok":true,"data":[],"meta":{"command":"transactions.duplicates","profile":"default","duration_ms":412,"schema_version":"2026-05-08","request_id":"6b0e2f8a-..."}}
```
