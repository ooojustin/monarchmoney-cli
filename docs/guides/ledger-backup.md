...
{"ok":true,"data":{"accounts":70,"holdings":3,"status":"sync complete","transactions":21},"meta":{"command":"cache.sync","profile":"default","duration_ms":1020,"schema_version":"2026-08-23","request_id":"284beeaf-5f65-4113-a433-1feb773408ee"}}
```
...
{"ok":true,"data":{"accounts":69,"file":"/Users/david/finances/monarch.journal","holdings":3,"status":"backup complete","transactions":3394},"meta":{"command":"hledger.backup","profile":"default","duration_ms":194,"schema_version":"2026-08-23","request_id":"d58b98f7-51ff-4203-8398-819209cc9482"}}
```

This reads only from the local cache - no network, no session needed. The journal path must differ from the cache path. That makes it safe to re-run constantly and to use offline:
...
```json
{"ok":true,"data":{"status":"sync complete","accounts":70,"holdings":3,"transactions":21,"backup":"/Users/david/finances/monarch.journal"},"meta":{"command":"cache.sync","schema_version":"2026-08-23","request_id":"..."}}
```
